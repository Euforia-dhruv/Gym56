...
const transformations = [
  {
    ...
    afterText: '70 kg',
    time: '3 Months',
    description: 'Lost 15 kg through consistent training and nutrition guidance',
  },
  {
    name: 'Priya',
    beforeWeight: 72,
    ...
    afterText: '62 kg',
    time: '6 Months',
    description: 'Complete transformation with strength and cardio training',
  },
  {
    name: 'Amit',
    beforeWeight: 90,
    ...
    afterText: '78 kg',
    time: '6 Months',
    description: 'From beginner to consistent gym-goer with 12 kg weight loss',
  },
];
