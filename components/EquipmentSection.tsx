...
const equipmentCategories = ["Cardio", "Strength", "Free Weights", "Machines", "Functional", "Recovery"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            Our <span className="text-[#DC2626]">Equipment</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Browse our extensive range of premium fitness equipment.
          </p>
        </motion.div>
